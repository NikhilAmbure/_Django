...
class OrderProgress(WebsocketConsumer):
    ...
    def connect(self):
        ...
        # ********************************
        # channel_layer.group_add => subscribes this connection to the group 
        # so that any message sent to this group will be forwarded to all members.
        # async_to_sync is used because the group_add function is async, but your consumer is synchronous.
